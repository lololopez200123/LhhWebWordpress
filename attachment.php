...
<?php if ( etheme_get_option('breadcrumb_type') != 9 ):  ?>
...
<div class="container">
	<div class="page-content">
		<div class="row">
			<div class="<?php echo esc_attr( $l['content-class'] ); ?>">
				<?php if(have_posts()): while(have_posts()) : the_post(); ?>
					...
					<article <?php post_class('blog-post post-single'); ?> id="post-<?php the_ID(); ?>">
						...
						<div class="post-info">
							...
							<span class="posted-by"> <?php esc_html_e('by', 'royal');?> <?php the_author_posts_link(); ?></span> /
