...
<div class="portfolio-item columns-count-<?php echo esc_attr($columns); ?> <?php echo esc_attr($span); ?> <?php echo esc_attr($catsClass); ?>">       
		<?php if (has_post_thumbnail( $postId ) ): ?>
			<div class="portfolio-image">
					...
					<a href="<?php the_permalink(); ?>"><img src="<?php echo esc_url($imgSrc); ?>" alt="<?php the_title(); ?>"></a>
					<div class="zoom">
						<div class="btn_group">
							<?php if($lightbox): ?><a href="<?php echo etheme_get_image(get_post_thumbnail_id($postId)); ?>" class="btn btn-black xmedium-btn" rel="lightbox"><span><?php esc_html_e('View large', 'royal'); ?></span></a><?php endif; ?>
